...
| Run the daily self-improvement scan | [RUNNING_DAILY_SELF_IMPROVEMENT.md](RUNNING_DAILY_SELF_IMPROVEMENT.md) |
...
| Day-to-day ops + emergency stop | [OPERATIONS_RUNBOOK.md](OPERATIONS_RUNBOOK.md) |
