...
> **Archived — decision receipt.** All four decisions recorded here were
> absorbed into live config (`configs/improvement.yaml`, `configs/proactive.yaml`,
> `configs/capabilities.yaml`) and code (`services/proactive_runner/collectors.py`).
> Nothing left to maintain in this file going forward.
