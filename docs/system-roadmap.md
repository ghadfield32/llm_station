...
deployment checklist see [STATUS.md](STATUS.md); for the deep system reference see
...
standards in [docs/backend/](backend/) are **real and authoritative — for the managed
...
| Self-improvement scheduler contract | daily observer scan, capped to report + Proposed backlog cards | [proactive.yaml](../configs/proactive.yaml), [daily-self-improvement-dag.md](daily-self-improvement-dag.md) |
...
### Track D — deployment (from [STATUS.md](STATUS.md))
...
The forecasting standards in [docs/backend/](backend/) (R2 locks, DAG run-location, medallion
