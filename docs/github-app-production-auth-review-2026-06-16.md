...
| Token storage / rotation | Drafted in [github-token-storage-rotation.md](github-token-storage-rotation.md); not final until branch-protection verification passes |
...
2. Document token generation, storage boundary, and rotation after the
   ...
   [github-token-storage-rotation.md](github-token-storage-rotation.md).
