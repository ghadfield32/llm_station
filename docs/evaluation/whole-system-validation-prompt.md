...
2. `docs/operations/STATUS.md`, `docs/improvement/improvement-loop.md`,
   `docs/improvement/daily-self-improvement-dag.md`, `docs/kanban/kanban-integration.md`,
   `docs/architecture/channels.md`, and `docs/MASTER.md` §5 (model lanes/routing) and
   §6.5 (model-update pipeline) — the standalone `model-routing.md`/`model-update.md`
   docs were retired 2026-07-08 in favor of those sections.
   `docs/reviews/system-roadmap.md`, `docs/reviews/agent-multiturn-and-memory.md`, and
   `docs/reviews/autonomous-pipeline-gap-review-2026-06-16.md` are archived — read their
   banners first, they point at what superseded them, if present.
   Then re-read this file (`docs/evaluation/whole-system-validation-prompt.md`) if present.
