...
per-platform steps (and how to add a brand-new transport) in [channels.md](../architecture/channels.md).
...
Work through [github-safety.md](../github/github-safety.md): protect `main`, CODEOWNERS, the scoped
...
- **Phase 3.5 — proactive ops lane:** scheduled DAG/data/repo checks → gated missions,
  ...
  ([proactive-ops.md](../improvement/proactive-ops.md), [daily-self-improvement-dag.md](../improvement/daily-self-improvement-dag.md)).
- **Phase 4 — workspace platforms:** Coder / OpenHands / Codespaces, only when tunnels are
  outgrown. Mirage stays a read-only watch-list experiment ([optional-mirage.md](../watch-list/optional-mirage.md)).
...
Current machine-by-machine progress against this list is tracked in [STATUS.md](../operations/STATUS.md).
