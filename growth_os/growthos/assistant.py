...
- kanban row editing: annotate_item appends Notes without clobbering; set_item_field
  ...
  the field. Use move_item/dedicated verbs for Status. Board layout is owned by the
  typed cockpit domain configuration; use its validated editor rather than guessing.
